...
import resource
import sg.studium.neurals.dataset.CsvDataSetIterator
import sg.studium.neurals.model.Dl4jModel
import java.io.FileOutputStream
import java.util.concurrent.TimeUnit

/**
 * Speed: 8437 epochs in 2 minutes on T460p I7 nd4j-native
 * Score: 56.42 @ epoch 8424 (64.02 @ epoch 7264 for anchor)
 */
class TrainRegressionFromCsv {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            val batchSize = 10
            val iterator = CsvDataSetIterator({ resource("cpu.onehot.data.csv") }, "class", batchSize)
...
//                .epochTerminationConditions(MaxEpochsTerminationCondition(300))
            ...
            dl4jModel.save(FileOutputStream("/tmp/cpu.onehot.fromcsv.dl4jmodel.zip"))

//            ModelSerializer.writeModel(bestModel, "/tmp/cpu.onehot.model.fromcsv.zip", true)
        }
    }
}